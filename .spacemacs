  ...
  (setq-default
   ...
   '(
     ...
     (python :variables
            ...
            lsp-python-ms-executable "~/.emacs.d/.cache/lsp/mspyls/output/bin/Release/Microsoft.Python.LanguageServer")
     ;; ----------------------------------------------------------------
...
(add-to-list 'exec-path "~/workdir/github/npm/node_modules/.bin" t)
)
